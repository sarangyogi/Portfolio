      ...
      <motion.div className="bg-stone-900 p-4">
        ...
        <motion.div className="container p-4 flex flex-wrap justify-evenly">
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            version="1.0"
            className="logo-react animate-logo rounded-full"
            width="100px"
            height="100px"
          ...
          >
            <g
              ...
              stroke="none"
            >
              <path d="M0 900 l0 -900 900 0 900 0 0 900 0 900 -900 0 -900 0 0 -900z m1021 472 c166 -46 290 -167 339 -331 29 -93 24 -225 -10 -314 -24 -64 -106 -180 -130 -185 -9 -1 -161 144 -355 338 l-340 341 40 36 c133 118 297 159 456 115z m129 -883 c0 -4 -14 -12 -31 -19 l-31 -13 -319 319 -318 319 16 33 16 34 334 -334 c183 -183 333 -336 333 -339z m-426 232 c297 -297 300 -301 228 -301 -22 0 -79 51 -285 253 l-259 252 7 43 c4 23 10 42 14 42 3 0 136 -130 295 -289z m76 -289 c-15 -5 -79 17 -143 51 -103 54 -210 195 -232 307 -6 32 11 18 189 -160 108 -107 192 -196 186 -198z" />
            </g>
          </svg>
        </motion.div>
      </motion.div>
